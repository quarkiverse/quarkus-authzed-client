...
public final class WatchPermissionsServiceGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<com.authzed.api.materialize.v0.WatchPermissionsRequest, com.authzed.api.materialize.v0.WatchPermissionsResponse> getWatchPermissionsMethod;

    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
            + "WatchPermissions", requestType = com.authzed.api.materialize.v0.WatchPermissionsRequest.class, responseType = com.authzed.api.materialize.v0.WatchPermissionsResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
    public static io.grpc.MethodDescriptor<com.authzed.api.materialize.v0.WatchPermissionsRequest, com.authzed.api.materialize.v0.WatchPermissionsResponse> getWatchPermissionsMethod() {
        ...
        if ((getWatchPermissionsMethod = WatchPermissionsServiceGrpc.getWatchPermissionsMethod) == null) {
            synchronized (WatchPermissionsServiceGrpc.class) {
                if ((getWatchPermissionsMethod = WatchPermissionsServiceGrpc.getWatchPermissionsMethod) == null) {
                    WatchPermissionsServiceGrpc.getWatchPermissionsMethod = getWatchPermissionsMethod = io.grpc.MethodDescriptor.<com.authzed.api.materialize.v0.WatchPermissionsRequest, com.authzed.api.materialize.v0.WatchPermissionsResponse> newBuilder()
                            ...
                            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils
                                    .marshaller(com.authzed.api.materialize.v0.WatchPermissionsRequest.getDefaultInstance()))
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils
                                    .marshaller(com.authzed.api.materialize.v0.WatchPermissionsResponse.getDefaultInstance()))
    ...
    public static WatchPermissionsServiceStub newStub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<WatchPermissionsServiceStub> factory = new io.grpc.stub.AbstractStub.StubFactory<WatchPermissionsServiceStub>() {
     ...
     */
    public static WatchPermissionsServiceBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<WatchPermissionsServiceBlockingV2Stub> factory = new io.grpc.stub.AbstractStub.StubFactory<WatchPermissionsServiceBlockingV2Stub>() {
     ...
     */
    public static WatchPermissionsServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<WatchPermissionsServiceBlockingStub> factory = new io.grpc.stub.AbstractStub.StubFactory<WatchPermissionsServiceBlockingStub>() {
     ...
     */
    public static WatchPermissionsServiceFutureStub newFutureStub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<WatchPermissionsServiceFutureStub> factory = new io.grpc.stub.AbstractStub.StubFactory<WatchPermissionsServiceFutureStub>() {
     ...
     */
    public static abstract class WatchPermissionsServiceImplBase implements io.grpc.BindableService, AsyncService {
     ...
     */
    public static class WatchPermissionsServiceStub extends io.grpc.stub.AbstractAsyncStub<WatchPermissionsServiceStub> {

        private WatchPermissionsServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected WatchPermissionsServiceStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new WatchPermissionsServiceStub(channel, callOptions);
        }
     ...
     */
    public static class WatchPermissionsServiceBlockingV2Stub
            extends io.grpc.stub.AbstractBlockingStub<WatchPermissionsServiceBlockingV2Stub> {

        private WatchPermissionsServiceBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected WatchPermissionsServiceBlockingV2Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new WatchPermissionsServiceBlockingV2Stub(channel, callOptions);
        }
        ...
        public io.grpc.stub.BlockingClientCall<?, com.authzed.api.materialize.v0.WatchPermissionsResponse> watchPermissions(
                com.authzed.api.materialize.v0.WatchPermissionsRequest request) {
            return io.grpc.stub.ClientCalls.blockingV2ServerStreamingCall(getChannel(), getWatchPermissionsMethod(),
     ...
     */
    public static class WatchPermissionsServiceBlockingStub
        ...
        @java.lang.Override
        protected WatchPermissionsServiceBlockingStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new WatchPermissionsServiceBlockingStub(channel, callOptions);
        }
        ...
        public java.util.Iterator<com.authzed.api.materialize.v0.WatchPermissionsResponse> watchPermissions(
                com.authzed.api.materialize.v0.WatchPermissionsRequest request) {
            return io.grpc.stub.ClientCalls.blockingServerStreamingCall(getChannel(), getWatchPermissionsMethod(),
                    getCallOptions(), request);
        }
    }
     ...
     */
    public static class WatchPermissionsServiceFutureStub
            extends io.grpc.stub.AbstractFutureStub<WatchPermissionsServiceFutureStub> {

        private WatchPermissionsServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected WatchPermissionsServiceFutureStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new WatchPermissionsServiceFutureStub(channel, callOptions);
        }
    }
    ...
    public static io.grpc.ServerServiceDefinition bindService(AsyncService service) {
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                .addMethod(getWatchPermissionsMethod(), io.grpc.stub.ServerCalls.asyncServerStreamingCall(
    ...
    private static final class WatchPermissionsServiceMethodDescriptorSupplier
            extends WatchPermissionsServiceBaseDescriptorSupplier implements io.grpc.protobuf.ProtoMethodDescriptorSupplier {
            ...
            synchronized (WatchPermissionsServiceGrpc.class) {
                ...
                if (result == null) {
                    serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
                            ...
                            .addMethod(getWatchPermissionsMethod()).build();
                }
            }
        }
        return result;
