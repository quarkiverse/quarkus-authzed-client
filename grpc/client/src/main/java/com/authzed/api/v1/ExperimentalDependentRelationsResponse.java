...
public final class ExperimentalDependentRelationsResponse extends com.google.protobuf.GeneratedMessage implements // @@protoc_insertion_point(message_implements:authzed.api.v1.ExperimentalDependentRelationsResponse)
    ...
    static {
        com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
                ...
                32, /* patch= */
                1, /* suffix= */
                "", ExperimentalDependentRelationsResponse.class.getName());
    }
    ...
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return com.authzed.api.v1.ExperimentalServiceOuterClass.internal_static_authzed_api_v1_ExperimentalDependentRelationsResponse_fieldAccessorTable
                .ensureFieldAccessorsInitialized(com.authzed.api.v1.ExperimentalDependentRelationsResponse.class,
                        com.authzed.api.v1.ExperimentalDependentRelationsResponse.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<? extends com.authzed.api.v1.ExpRelationReferenceOrBuilder> getRelationsOrBuilderList() {
        return relations_;
    }
     ...
     */
    @java.lang.Override
    public com.authzed.api.v1.ExpRelationReferenceOrBuilder getRelationsOrBuilder(int index) {
        return relations_.get(index);
    }
    ...
    public int getSerializedSize() {
        ...
        size = 0;
        for (int i = 0; i < relations_.size(); i++) {
            size += com.google.protobuf.CodedOutputStream.computeMessageSize(1, relations_.get(i));
        }
        if (((bitField0_ & 0x00000001) != 0)) {
    ...
    public static com.authzed.api.v1.ExperimentalDependentRelationsResponse parseFrom(java.nio.ByteBuffer data)
    ...
    public static com.authzed.api.v1.ExperimentalDependentRelationsResponse parseFrom(com.google.protobuf.ByteString data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
    }
     ...
     * Protobuf type {@code authzed.api.v1.ExperimentalDependentRelationsResponse}
     */
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder> implements // @@protoc_insertion_point(builder_implements:authzed.api.v1.ExperimentalDependentRelationsResponse)
        ...
        public com.authzed.api.v1.ExperimentalDependentRelationsResponse buildPartial() {
            com.authzed.api.v1.ExperimentalDependentRelationsResponse result = new com.authzed.api.v1.ExperimentalDependentRelationsResponse(
                    this);
        ...
        public Builder mergeFrom(com.authzed.api.v1.ExperimentalDependentRelationsResponse other) {
            if (other == com.authzed.api.v1.ExperimentalDependentRelationsResponse.getDefaultInstance())
                return this;
            if (relationsBuilder_ == null) {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        case 0:
                            ...
                            break;
                        case 10: {
                            com.authzed.api.v1.ExpRelationReference m = input
                                    .readMessage(com.authzed.api.v1.ExpRelationReference.parser(), extensionRegistry);
                            if (relationsBuilder_ == null) {
                                ensureRelationsIsMutable();
                                relations_.add(m);
                            } else {
        ...
        private java.util.List<com.authzed.api.v1.ExpRelationReference> relations_ = java.util.Collections.emptyList();
        ...
        private com.google.protobuf.RepeatedFieldBuilder<com.authzed.api.v1.ExpRelationReference, com.authzed.api.v1.ExpRelationReference.Builder, com.authzed.api.v1.ExpRelationReferenceOrBuilder> relationsBuilder_;
         ...
         * <code>repeated .authzed.api.v1.ExpRelationReference relations = 1;</code>
         */
        public Builder setRelations(int index, com.authzed.api.v1.ExpRelationReference value) {
            if (relationsBuilder_ == null) {
                if (value == null) {
         ...
         * <code>repeated .authzed.api.v1.ExpRelationReference relations = 1;</code>
         */
        public Builder setRelations(int index, com.authzed.api.v1.ExpRelationReference.Builder builderForValue) {
            if (relationsBuilder_ == null) {
                ensureRelationsIsMutable();
         ...
         * <code>repeated .authzed.api.v1.ExpRelationReference relations = 1;</code>
         */
        public Builder addRelations(int index, com.authzed.api.v1.ExpRelationReference value) {
            if (relationsBuilder_ == null) {
                if (value == null) {
                    throw new NullPointerException();
                }
         ...
         * <code>repeated .authzed.api.v1.ExpRelationReference relations = 1;</code>
         */
        public Builder addRelations(com.authzed.api.v1.ExpRelationReference.Builder builderForValue) {
            if (relationsBuilder_ == null) {
                ensureRelationsIsMutable();
         ...
         * <code>repeated .authzed.api.v1.ExpRelationReference relations = 1;</code>
         */
        public Builder addRelations(int index, com.authzed.api.v1.ExpRelationReference.Builder builderForValue) {
            if (relationsBuilder_ == null) {
                ensureRelationsIsMutable();
         ...
         * <code>repeated .authzed.api.v1.ExpRelationReference relations = 1;</code>
         */
        public Builder addAllRelations(java.lang.Iterable<? extends com.authzed.api.v1.ExpRelationReference> values) {
            if (relationsBuilder_ == null) {
                ensureRelationsIsMutable();
         ...
         * <code>repeated .authzed.api.v1.ExpRelationReference relations = 1;</code>
         */
        public com.authzed.api.v1.ExpRelationReference.Builder getRelationsBuilder(int index) {
        ...
        public com.authzed.api.v1.ExpRelationReference.Builder addRelationsBuilder() {
            return internalGetRelationsFieldBuilder().addBuilder(com.authzed.api.v1.ExpRelationReference.getDefaultInstance());
        }

        /**
         * <code>repeated .authzed.api.v1.ExpRelationReference relations = 1;</code>
         */
        public com.authzed.api.v1.ExpRelationReference.Builder addRelationsBuilder(int index) {
         ...
         * <code>repeated .authzed.api.v1.ExpRelationReference relations = 1;</code>
         */
        public java.util.List<com.authzed.api.v1.ExpRelationReference.Builder> getRelationsBuilderList() {
            return internalGetRelationsFieldBuilder().getBuilderList();
        }

        private com.google.protobuf.RepeatedFieldBuilder<com.authzed.api.v1.ExpRelationReference, com.authzed.api.v1.ExpRelationReference.Builder, com.authzed.api.v1.ExpRelationReferenceOrBuilder> internalGetRelationsFieldBuilder() {
            if (relationsBuilder_ == null) {
                relationsBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<com.authzed.api.v1.ExpRelationReference, com.authzed.api.v1.ExpRelationReference.Builder, com.authzed.api.v1.ExpRelationReferenceOrBuilder>(
                        relations_, ((bitField0_ & 0x00000001) != 0), getParentForChildren(), isClean());
                relations_ = null;
            }
    ...
    private static final com.google.protobuf.Parser<ExperimentalDependentRelationsResponse> PARSER = new com.google.protobuf.AbstractParser<ExperimentalDependentRelationsResponse>() {

        @java.lang.Override
        public ExperimentalDependentRelationsResponse parsePartialFrom(com.google.protobuf.CodedInputStream input,
                com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                throws com.google.protobuf.InvalidProtocolBufferException {
