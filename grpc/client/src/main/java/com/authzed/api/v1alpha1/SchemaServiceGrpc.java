 ...
 * </pre>
 */
@io.quarkus.grpc.common.Generated(value = "by gRPC proto compiler (version 1.48.1)", comments = "Source: authzed/api/v1alpha1/schema.proto")
...
public final class SchemaServiceGrpc {
    ...
    public static final String SERVICE_NAME = "authzed.api.v1alpha1.SchemaService";

    // Static method descriptors that strictly reflect the proto.
    private static volatile io.grpc.MethodDescriptor<com.authzed.api.v1alpha1.Schema.ReadSchemaRequest, com.authzed.api.v1alpha1.Schema.ReadSchemaResponse> getReadSchemaMethod;

    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
            + "ReadSchema", requestType = com.authzed.api.v1alpha1.Schema.ReadSchemaRequest.class, responseType = com.authzed.api.v1alpha1.Schema.ReadSchemaResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<com.authzed.api.v1alpha1.Schema.ReadSchemaRequest, com.authzed.api.v1alpha1.Schema.ReadSchemaResponse> getReadSchemaMethod() {
        ...
        if ((getReadSchemaMethod = SchemaServiceGrpc.getReadSchemaMethod) == null) {
            synchronized (SchemaServiceGrpc.class) {
                if ((getReadSchemaMethod = SchemaServiceGrpc.getReadSchemaMethod) == null) {
                    SchemaServiceGrpc.getReadSchemaMethod = getReadSchemaMethod = io.grpc.MethodDescriptor.<com.authzed.api.v1alpha1.Schema.ReadSchemaRequest, com.authzed.api.v1alpha1.Schema.ReadSchemaResponse> newBuilder()
                            ...
                            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils
                                    .marshaller(com.authzed.api.v1alpha1.Schema.ReadSchemaRequest.getDefaultInstance()))
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils
                                    .marshaller(com.authzed.api.v1alpha1.Schema.ReadSchemaResponse.getDefaultInstance()))
    ...
    private static volatile io.grpc.MethodDescriptor<com.authzed.api.v1alpha1.Schema.WriteSchemaRequest, com.authzed.api.v1alpha1.Schema.WriteSchemaResponse> getWriteSchemaMethod;

    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
            + "WriteSchema", requestType = com.authzed.api.v1alpha1.Schema.WriteSchemaRequest.class, responseType = com.authzed.api.v1alpha1.Schema.WriteSchemaResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<com.authzed.api.v1alpha1.Schema.WriteSchemaRequest, com.authzed.api.v1alpha1.Schema.WriteSchemaResponse> getWriteSchemaMethod() {
        ...
        if ((getWriteSchemaMethod = SchemaServiceGrpc.getWriteSchemaMethod) == null) {
            synchronized (SchemaServiceGrpc.class) {
                if ((getWriteSchemaMethod = SchemaServiceGrpc.getWriteSchemaMethod) == null) {
                    SchemaServiceGrpc.getWriteSchemaMethod = getWriteSchemaMethod = io.grpc.MethodDescriptor.<com.authzed.api.v1alpha1.Schema.WriteSchemaRequest, com.authzed.api.v1alpha1.Schema.WriteSchemaResponse> newBuilder()
                            .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                            .setFullMethodName(generateFullMethodName(SERVICE_NAME, "WriteSchema"))
                            .setSampledToLocalTracing(true)
                            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils
                                    .marshaller(com.authzed.api.v1alpha1.Schema.WriteSchemaRequest.getDefaultInstance()))
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils
                                    .marshaller(com.authzed.api.v1alpha1.Schema.WriteSchemaResponse.getDefaultInstance()))
    ...
    public static class SchemaServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<SchemaServiceBlockingStub> {
         ...
         * </pre>
         */
        public com.authzed.api.v1alpha1.Schema.ReadSchemaResponse readSchema(
         ...
         * </pre>
         */
        public com.authzed.api.v1alpha1.Schema.WriteSchemaResponse writeSchema(
