...
public final class WatchPermissionSetsServiceGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<com.authzed.api.materialize.v0.WatchPermissionSetsRequest, com.authzed.api.materialize.v0.WatchPermissionSetsResponse> getWatchPermissionSetsMethod;

    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
            + "WatchPermissionSets", requestType = com.authzed.api.materialize.v0.WatchPermissionSetsRequest.class, responseType = com.authzed.api.materialize.v0.WatchPermissionSetsResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
    public static io.grpc.MethodDescriptor<com.authzed.api.materialize.v0.WatchPermissionSetsRequest, com.authzed.api.materialize.v0.WatchPermissionSetsResponse> getWatchPermissionSetsMethod() {
        ...
        if ((getWatchPermissionSetsMethod = WatchPermissionSetsServiceGrpc.getWatchPermissionSetsMethod) == null) {
            synchronized (WatchPermissionSetsServiceGrpc.class) {
                if ((getWatchPermissionSetsMethod = WatchPermissionSetsServiceGrpc.getWatchPermissionSetsMethod) == null) {
                    WatchPermissionSetsServiceGrpc.getWatchPermissionSetsMethod = getWatchPermissionSetsMethod = io.grpc.MethodDescriptor.<com.authzed.api.materialize.v0.WatchPermissionSetsRequest, com.authzed.api.materialize.v0.WatchPermissionSetsResponse> newBuilder()
                            ...
                            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils
                                    .marshaller(com.authzed.api.materialize.v0.WatchPermissionSetsRequest.getDefaultInstance()))
    ...
    private static volatile io.grpc.MethodDescriptor<com.authzed.api.materialize.v0.LookupPermissionSetsRequest, com.authzed.api.materialize.v0.LookupPermissionSetsResponse> getLookupPermissionSetsMethod;

    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
            + "LookupPermissionSets", requestType = com.authzed.api.materialize.v0.LookupPermissionSetsRequest.class, responseType = com.authzed.api.materialize.v0.LookupPermissionSetsResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
    public static io.grpc.MethodDescriptor<com.authzed.api.materialize.v0.LookupPermissionSetsRequest, com.authzed.api.materialize.v0.LookupPermissionSetsResponse> getLookupPermissionSetsMethod() {
        ...
        if ((getLookupPermissionSetsMethod = WatchPermissionSetsServiceGrpc.getLookupPermissionSetsMethod) == null) {
            synchronized (WatchPermissionSetsServiceGrpc.class) {
                if ((getLookupPermissionSetsMethod = WatchPermissionSetsServiceGrpc.getLookupPermissionSetsMethod) == null) {
                    WatchPermissionSetsServiceGrpc.getLookupPermissionSetsMethod = getLookupPermissionSetsMethod = io.grpc.MethodDescriptor.<com.authzed.api.materialize.v0.LookupPermissionSetsRequest, com.authzed.api.materialize.v0.LookupPermissionSetsResponse> newBuilder()
                            .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
    ...
    private static volatile io.grpc.MethodDescriptor<com.authzed.api.materialize.v0.DownloadPermissionSetsRequest, com.authzed.api.materialize.v0.DownloadPermissionSetsResponse> getDownloadPermissionSetsMethod;

    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
            + "DownloadPermissionSets", requestType = com.authzed.api.materialize.v0.DownloadPermissionSetsRequest.class, responseType = com.authzed.api.materialize.v0.DownloadPermissionSetsResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<com.authzed.api.materialize.v0.DownloadPermissionSetsRequest, com.authzed.api.materialize.v0.DownloadPermissionSetsResponse> getDownloadPermissionSetsMethod() {
        ...
        if ((getDownloadPermissionSetsMethod = WatchPermissionSetsServiceGrpc.getDownloadPermissionSetsMethod) == null) {
            synchronized (WatchPermissionSetsServiceGrpc.class) {
                if ((getDownloadPermissionSetsMethod = WatchPermissionSetsServiceGrpc.getDownloadPermissionSetsMethod) == null) {
                    WatchPermissionSetsServiceGrpc.getDownloadPermissionSetsMethod = getDownloadPermissionSetsMethod = io.grpc.MethodDescriptor.<com.authzed.api.materialize.v0.DownloadPermissionSetsRequest, com.authzed.api.materialize.v0.DownloadPermissionSetsResponse> newBuilder()
                            ...
                            .setSchemaDescriptor(
                                    new WatchPermissionSetsServiceMethodDescriptorSupplier("DownloadPermissionSets"))
                            .build();
                }
            }
        }
    ...
    public static WatchPermissionSetsServiceStub newStub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<WatchPermissionSetsServiceStub> factory = new io.grpc.stub.AbstractStub.StubFactory<WatchPermissionSetsServiceStub>() {
     ...
     */
    public static WatchPermissionSetsServiceBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<WatchPermissionSetsServiceBlockingV2Stub> factory = new io.grpc.stub.AbstractStub.StubFactory<WatchPermissionSetsServiceBlockingV2Stub>() {
     ...
     */
    public static WatchPermissionSetsServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<WatchPermissionSetsServiceBlockingStub> factory = new io.grpc.stub.AbstractStub.StubFactory<WatchPermissionSetsServiceBlockingStub>() {
     ...
     */
    public static WatchPermissionSetsServiceFutureStub newFutureStub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<WatchPermissionSetsServiceFutureStub> factory = new io.grpc.stub.AbstractStub.StubFactory<WatchPermissionSetsServiceFutureStub>() {
     ...
     */
    public static abstract class WatchPermissionSetsServiceImplBase implements io.grpc.BindableService, AsyncService {
     ...
     */
    public static class WatchPermissionSetsServiceStub extends io.grpc.stub.AbstractAsyncStub<WatchPermissionSetsServiceStub> {

        private WatchPermissionSetsServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected WatchPermissionSetsServiceStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new WatchPermissionSetsServiceStub(channel, callOptions);
        }
        ...
        public void downloadPermissionSets(com.authzed.api.materialize.v0.DownloadPermissionSetsRequest request,
                io.grpc.stub.StreamObserver<com.authzed.api.materialize.v0.DownloadPermissionSetsResponse> responseObserver) {
            io.grpc.stub.ClientCalls.asyncUnaryCall(getChannel().newCall(getDownloadPermissionSetsMethod(), getCallOptions()),
     ...
     */
    public static class WatchPermissionSetsServiceBlockingV2Stub
            extends io.grpc.stub.AbstractBlockingStub<WatchPermissionSetsServiceBlockingV2Stub> {

        private WatchPermissionSetsServiceBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected WatchPermissionSetsServiceBlockingV2Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new WatchPermissionSetsServiceBlockingV2Stub(channel, callOptions);
        }
        ...
        public io.grpc.stub.BlockingClientCall<?, com.authzed.api.materialize.v0.WatchPermissionSetsResponse> watchPermissionSets(
                com.authzed.api.materialize.v0.WatchPermissionSetsRequest request) {
            return io.grpc.stub.ClientCalls.blockingV2ServerStreamingCall(getChannel(), getWatchPermissionSetsMethod(),
         ...
         */
        @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
        public io.grpc.stub.BlockingClientCall<?, com.authzed.api.materialize.v0.LookupPermissionSetsResponse> lookupPermissionSets(
                com.authzed.api.materialize.v0.LookupPermissionSetsRequest request) {
            return io.grpc.stub.ClientCalls.blockingV2ServerStreamingCall(getChannel(), getLookupPermissionSetsMethod(),
                    getCallOptions(), request);
        }
         ...
         * </pre>
         */
        public com.authzed.api.materialize.v0.DownloadPermissionSetsResponse downloadPermissionSets(
                com.authzed.api.materialize.v0.DownloadPermissionSetsRequest request) throws io.grpc.StatusException {
            return io.grpc.stub.ClientCalls.blockingV2UnaryCall(getChannel(), getDownloadPermissionSetsMethod(),
                    getCallOptions(), request);
        }
    }
     ...
     */
    public static class WatchPermissionSetsServiceBlockingStub
        ...
        @java.lang.Override
        protected WatchPermissionSetsServiceBlockingStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new WatchPermissionSetsServiceBlockingStub(channel, callOptions);
        }
        ...
        public java.util.Iterator<com.authzed.api.materialize.v0.WatchPermissionSetsResponse> watchPermissionSets(
                com.authzed.api.materialize.v0.WatchPermissionSetsRequest request) {
            return io.grpc.stub.ClientCalls.blockingServerStreamingCall(getChannel(), getWatchPermissionSetsMethod(),
                    getCallOptions(), request);
        }
        ...
        public java.util.Iterator<com.authzed.api.materialize.v0.LookupPermissionSetsResponse> lookupPermissionSets(
                com.authzed.api.materialize.v0.LookupPermissionSetsRequest request) {
            return io.grpc.stub.ClientCalls.blockingServerStreamingCall(getChannel(), getLookupPermissionSetsMethod(),
                    getCallOptions(), request);
        }
        ...
        public com.authzed.api.materialize.v0.DownloadPermissionSetsResponse downloadPermissionSets(
            ...
            return io.grpc.stub.ClientCalls.blockingUnaryCall(getChannel(), getDownloadPermissionSetsMethod(), getCallOptions(),
                    request);
        }
    }
     ...
     */
    public static class WatchPermissionSetsServiceFutureStub
            extends io.grpc.stub.AbstractFutureStub<WatchPermissionSetsServiceFutureStub> {

        private WatchPermissionSetsServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected WatchPermissionSetsServiceFutureStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new WatchPermissionSetsServiceFutureStub(channel, callOptions);
        }
        ...
        public com.google.common.util.concurrent.ListenableFuture<com.authzed.api.materialize.v0.DownloadPermissionSetsResponse> downloadPermissionSets(
            ...
            return io.grpc.stub.ClientCalls
                    .futureUnaryCall(getChannel().newCall(getDownloadPermissionSetsMethod(), getCallOptions()), request);
        }
    }
    ...
    public static io.grpc.ServerServiceDefinition bindService(AsyncService service) {
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                .addMethod(getWatchPermissionSetsMethod(), io.grpc.stub.ServerCalls.asyncServerStreamingCall(
                ...
                .addMethod(getLookupPermissionSetsMethod(), io.grpc.stub.ServerCalls.asyncServerStreamingCall(
                ...
                .addMethod(getDownloadPermissionSetsMethod(), io.grpc.stub.ServerCalls.asyncUnaryCall(
    ...
    private static final class WatchPermissionSetsServiceMethodDescriptorSupplier
            extends WatchPermissionSetsServiceBaseDescriptorSupplier implements io.grpc.protobuf.ProtoMethodDescriptorSupplier {
            ...
            synchronized (WatchPermissionSetsServiceGrpc.class) {
                ...
                if (result == null) {
                    serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
                            ...
                            .addMethod(getWatchPermissionSetsMethod()).addMethod(getLookupPermissionSetsMethod())
                            .addMethod(getDownloadPermissionSetsMethod()).build();
                }
            }
        }
        return result;
