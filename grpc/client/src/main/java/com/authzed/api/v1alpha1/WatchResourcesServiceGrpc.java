 ...
 * </pre>
 */
@io.quarkus.grpc.common.Generated(value = "by gRPC proto compiler (version 1.48.1)", comments = "Source: authzed/api/v1alpha1/watchresources_service.proto")
...
public final class WatchResourcesServiceGrpc {
    ...
    public static WatchResourcesServiceStub newStub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<WatchResourcesServiceStub> factory = new io.grpc.stub.AbstractStub.StubFactory<WatchResourcesServiceStub>() {
     ...
     */
    public static WatchResourcesServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<WatchResourcesServiceBlockingStub> factory = new io.grpc.stub.AbstractStub.StubFactory<WatchResourcesServiceBlockingStub>() {
     ...
     */
    public static WatchResourcesServiceFutureStub newFutureStub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<WatchResourcesServiceFutureStub> factory = new io.grpc.stub.AbstractStub.StubFactory<WatchResourcesServiceFutureStub>() {
     ...
     * </pre>
     */
    public static class WatchResourcesServiceStub extends io.grpc.stub.AbstractAsyncStub<WatchResourcesServiceStub> {

        private WatchResourcesServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected WatchResourcesServiceStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new WatchResourcesServiceStub(channel, callOptions);
        }
     ...
     * </pre>
     */
    public static class WatchResourcesServiceBlockingStub
        ...
        @java.lang.Override
        protected WatchResourcesServiceBlockingStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new WatchResourcesServiceBlockingStub(channel, callOptions);
        }
     ...
     * </pre>
     */
    public static class WatchResourcesServiceFutureStub
            extends io.grpc.stub.AbstractFutureStub<WatchResourcesServiceFutureStub> {

        private WatchResourcesServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected WatchResourcesServiceFutureStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new WatchResourcesServiceFutureStub(channel, callOptions);
        }
    }
    ...
    private static final class WatchResourcesServiceFileDescriptorSupplier extends WatchResourcesServiceBaseDescriptorSupplier {
            ...
            synchronized (WatchResourcesServiceGrpc.class) {
                ...
                if (result == null) {
                    serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
                            ...
                            .addMethod(getWatchResourcesMethod()).build();
                }
            }
        }
        return result;
