...
public final class Violations extends com.google.protobuf.GeneratedMessage implements // @@protoc_insertion_point(message_implements:buf.validate.Violations)
        ViolationsOrBuilder {
    ...
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return build.buf.validate.ValidateProto.internal_static_buf_validate_Violations_fieldAccessorTable
                .ensureFieldAccessorsInitialized(build.buf.validate.Violations.class,
                        build.buf.validate.Violations.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<? extends build.buf.validate.ViolationOrBuilder> getViolationsOrBuilderList() {
        return violations_;
    }
     ...
     */
    @java.lang.Override
    public build.buf.validate.ViolationOrBuilder getViolationsOrBuilder(int index) {
        return violations_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (!getViolationsList().equals(other.getViolationsList()))
            return false;
    ...
    public static build.buf.validate.Violations parseFrom(java.nio.ByteBuffer data)
    ...
    public static build.buf.validate.Violations parseFrom(com.google.protobuf.ByteString data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
    }
    ...
    public static build.buf.validate.Violations parseFrom(java.io.InputStream input) throws java.io.IOException {
    ...
    public static build.buf.validate.Violations parseDelimitedFrom(java.io.InputStream input) throws java.io.IOException {
    ...
    public static build.buf.validate.Violations parseFrom(com.google.protobuf.CodedInputStream input)
     ...
     * Protobuf type {@code buf.validate.Violations}
     */
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder> implements // @@protoc_insertion_point(builder_implements:buf.validate.Violations)
        ...
        public Builder mergeFrom(build.buf.validate.Violations other) {
            if (other == build.buf.validate.Violations.getDefaultInstance())
                return this;
            if (violationsBuilder_ == null) {
                ...
                if (!other.violations_.isEmpty()) {
                    if (violationsBuilder_.isEmpty()) {
                        ...
                        violations_ = other.violations_;
                        bitField0_ = (bitField0_ & ~0x00000001);
                        violationsBuilder_ = com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        case 0:
                            ...
                            break;
                        case 10: {
                            build.buf.validate.Violation m = input.readMessage(build.buf.validate.Violation.parser(),
                                    extensionRegistry);
                            if (violationsBuilder_ == null) {
                                ensureViolationsIsMutable();
                                violations_.add(m);
        ...
        private java.util.List<build.buf.validate.Violation> violations_ = java.util.Collections.emptyList();
        ...
        private com.google.protobuf.RepeatedFieldBuilder<build.buf.validate.Violation, build.buf.validate.Violation.Builder, build.buf.validate.ViolationOrBuilder> violationsBuilder_;
         ...
         * <code>repeated .buf.validate.Violation violations = 1;</code>
         */
        public Builder setViolations(int index, build.buf.validate.Violation value) {
            if (violationsBuilder_ == null) {
                if (value == null) {
         ...
         * <code>repeated .buf.validate.Violation violations = 1;</code>
         */
        public Builder setViolations(int index, build.buf.validate.Violation.Builder builderForValue) {
            if (violationsBuilder_ == null) {
                ensureViolationsIsMutable();
         ...
         * <code>repeated .buf.validate.Violation violations = 1;</code>
         */
        public Builder addViolations(int index, build.buf.validate.Violation value) {
            if (violationsBuilder_ == null) {
                if (value == null) {
                    throw new NullPointerException();
                }
         ...
         * <code>repeated .buf.validate.Violation violations = 1;</code>
         */
        public Builder addViolations(build.buf.validate.Violation.Builder builderForValue) {
            if (violationsBuilder_ == null) {
                ensureViolationsIsMutable();
         ...
         * <code>repeated .buf.validate.Violation violations = 1;</code>
         */
        public Builder addViolations(int index, build.buf.validate.Violation.Builder builderForValue) {
            if (violationsBuilder_ == null) {
                ensureViolationsIsMutable();
         ...
         * <code>repeated .buf.validate.Violation violations = 1;</code>
         */
        public Builder addAllViolations(java.lang.Iterable<? extends build.buf.validate.Violation> values) {
            if (violationsBuilder_ == null) {
                ensureViolationsIsMutable();
         ...
         * <code>repeated .buf.validate.Violation violations = 1;</code>
         */
        public build.buf.validate.Violation.Builder getViolationsBuilder(int index) {
        ...
        public build.buf.validate.Violation.Builder addViolationsBuilder() {
            return internalGetViolationsFieldBuilder().addBuilder(build.buf.validate.Violation.getDefaultInstance());
        }
         ...
         * <code>repeated .buf.validate.Violation violations = 1;</code>
         */
        public build.buf.validate.Violation.Builder addViolationsBuilder(int index) {
            return internalGetViolationsFieldBuilder().addBuilder(index, build.buf.validate.Violation.getDefaultInstance());
        }
         ...
         * <code>repeated .buf.validate.Violation violations = 1;</code>
         */
        public java.util.List<build.buf.validate.Violation.Builder> getViolationsBuilderList() {
            return internalGetViolationsFieldBuilder().getBuilderList();
        }

        private com.google.protobuf.RepeatedFieldBuilder<build.buf.validate.Violation, build.buf.validate.Violation.Builder, build.buf.validate.ViolationOrBuilder> internalGetViolationsFieldBuilder() {
            if (violationsBuilder_ == null) {
                violationsBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<build.buf.validate.Violation, build.buf.validate.Violation.Builder, build.buf.validate.ViolationOrBuilder>(
    ...
    private static final com.google.protobuf.Parser<Violations> PARSER = new com.google.protobuf.AbstractParser<Violations>() {

        @java.lang.Override
        public Violations parsePartialFrom(com.google.protobuf.CodedInputStream input,
                com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                throws com.google.protobuf.InvalidProtocolBufferException {
