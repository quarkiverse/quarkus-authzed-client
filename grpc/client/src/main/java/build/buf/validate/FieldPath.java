...
public final class FieldPath extends com.google.protobuf.GeneratedMessage implements // @@protoc_insertion_point(message_implements:buf.validate.FieldPath)
        FieldPathOrBuilder {
    ...
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return build.buf.validate.ValidateProto.internal_static_buf_validate_FieldPath_fieldAccessorTable
                .ensureFieldAccessorsInitialized(build.buf.validate.FieldPath.class,
                        build.buf.validate.FieldPath.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<? extends build.buf.validate.FieldPathElementOrBuilder> getElementsOrBuilderList() {
        return elements_;
    }
     ...
     */
    @java.lang.Override
    public build.buf.validate.FieldPathElementOrBuilder getElementsOrBuilder(int index) {
        return elements_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (!getElementsList().equals(other.getElementsList()))
            return false;
    ...
    public static build.buf.validate.FieldPath parseFrom(java.nio.ByteBuffer data)
    ...
    public static build.buf.validate.FieldPath parseFrom(com.google.protobuf.ByteString data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
    }
    ...
    public static build.buf.validate.FieldPath parseFrom(java.io.InputStream input) throws java.io.IOException {
    ...
    public static build.buf.validate.FieldPath parseDelimitedFrom(java.io.InputStream input) throws java.io.IOException {
    ...
    public static build.buf.validate.FieldPath parseFrom(com.google.protobuf.CodedInputStream input)
     ...
     * Protobuf type {@code buf.validate.FieldPath}
     */
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder> implements // @@protoc_insertion_point(builder_implements:buf.validate.FieldPath)
        ...
        public Builder mergeFrom(build.buf.validate.FieldPath other) {
            if (other == build.buf.validate.FieldPath.getDefaultInstance())
                return this;
            if (elementsBuilder_ == null) {
                ...
                if (!other.elements_.isEmpty()) {
                    if (elementsBuilder_.isEmpty()) {
                        ...
                        elements_ = other.elements_;
                        bitField0_ = (bitField0_ & ~0x00000001);
                        elementsBuilder_ = com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        case 0:
                            ...
                            break;
                        case 10: {
                            build.buf.validate.FieldPathElement m = input
                                    .readMessage(build.buf.validate.FieldPathElement.parser(), extensionRegistry);
                            if (elementsBuilder_ == null) {
                                ensureElementsIsMutable();
                                elements_.add(m);
                            } else {
        ...
        private java.util.List<build.buf.validate.FieldPathElement> elements_ = java.util.Collections.emptyList();
        ...
        private com.google.protobuf.RepeatedFieldBuilder<build.buf.validate.FieldPathElement, build.buf.validate.FieldPathElement.Builder, build.buf.validate.FieldPathElementOrBuilder> elementsBuilder_;
         ...
         * <code>repeated .buf.validate.FieldPathElement elements = 1;</code>
         */
        public Builder setElements(int index, build.buf.validate.FieldPathElement value) {
            if (elementsBuilder_ == null) {
                if (value == null) {
         ...
         * <code>repeated .buf.validate.FieldPathElement elements = 1;</code>
         */
        public Builder setElements(int index, build.buf.validate.FieldPathElement.Builder builderForValue) {
            if (elementsBuilder_ == null) {
                ensureElementsIsMutable();
         ...
         * <code>repeated .buf.validate.FieldPathElement elements = 1;</code>
         */
        public Builder addElements(int index, build.buf.validate.FieldPathElement value) {
            if (elementsBuilder_ == null) {
                if (value == null) {
                    throw new NullPointerException();
                }
         ...
         * <code>repeated .buf.validate.FieldPathElement elements = 1;</code>
         */
        public Builder addElements(build.buf.validate.FieldPathElement.Builder builderForValue) {
            if (elementsBuilder_ == null) {
                ensureElementsIsMutable();
         ...
         * <code>repeated .buf.validate.FieldPathElement elements = 1;</code>
         */
        public Builder addElements(int index, build.buf.validate.FieldPathElement.Builder builderForValue) {
            if (elementsBuilder_ == null) {
                ensureElementsIsMutable();
         ...
         * <code>repeated .buf.validate.FieldPathElement elements = 1;</code>
         */
        public Builder addAllElements(java.lang.Iterable<? extends build.buf.validate.FieldPathElement> values) {
            if (elementsBuilder_ == null) {
                ensureElementsIsMutable();
         ...
         * <code>repeated .buf.validate.FieldPathElement elements = 1;</code>
         */
        public build.buf.validate.FieldPathElement.Builder getElementsBuilder(int index) {
        ...
        public build.buf.validate.FieldPathElement.Builder addElementsBuilder() {
            return internalGetElementsFieldBuilder().addBuilder(build.buf.validate.FieldPathElement.getDefaultInstance());
        }
         ...
         * <code>repeated .buf.validate.FieldPathElement elements = 1;</code>
         */
        public build.buf.validate.FieldPathElement.Builder addElementsBuilder(int index) {
            return internalGetElementsFieldBuilder().addBuilder(index,
         ...
         * <code>repeated .buf.validate.FieldPathElement elements = 1;</code>
         */
        public java.util.List<build.buf.validate.FieldPathElement.Builder> getElementsBuilderList() {
            return internalGetElementsFieldBuilder().getBuilderList();
        }

        private com.google.protobuf.RepeatedFieldBuilder<build.buf.validate.FieldPathElement, build.buf.validate.FieldPathElement.Builder, build.buf.validate.FieldPathElementOrBuilder> internalGetElementsFieldBuilder() {
            if (elementsBuilder_ == null) {
                elementsBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<build.buf.validate.FieldPathElement, build.buf.validate.FieldPathElement.Builder, build.buf.validate.FieldPathElementOrBuilder>(
    ...
    private static final com.google.protobuf.Parser<FieldPath> PARSER = new com.google.protobuf.AbstractParser<FieldPath>() {

        @java.lang.Override
        public FieldPath parsePartialFrom(com.google.protobuf.CodedInputStream input,
                com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                throws com.google.protobuf.InvalidProtocolBufferException {
