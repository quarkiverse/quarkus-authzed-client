...
a|icon:lock[title=Fixed at build time] [[config-group-io-quarkiverse-authzed-client-deployment-metrics-config_quarkus.authzed.dev-services.metrics.tls-cert-key]]`link:#config-group-io-quarkiverse-authzed-client-deployment-metrics-config_quarkus.authzed.dev-services.metrics.tls-cert-key[quarkus.authzed.dev-services.metrics.tls-cert-key]`
