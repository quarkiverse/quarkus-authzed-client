...
a|icon:lock[title=Fixed at build time] [[quarkus-authzed_quarkus.authzed.dev-services.grpc.tls-cert-key]]`link:#quarkus-authzed_quarkus.authzed.dev-services.grpc.tls-cert-key[quarkus.authzed.dev-services.grpc.tls-cert-key]`
...
a|icon:lock[title=Fixed at build time] [[quarkus-authzed_quarkus.authzed.dev-services.metrics.tls-cert-key]]`link:#quarkus-authzed_quarkus.authzed.dev-services.metrics.tls-cert-key[quarkus.authzed.dev-services.metrics.tls-cert-key]`
